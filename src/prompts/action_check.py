...
def p_format_check(error_actions: str, suggestions: list[str]) -> str:
    """动作格式错误，指导再次生成"""
    return (
        f"Previously, you have made actions with invalid names or input formats:\n"
        f"{error_actions} \n"
...
def p_logic_check(error_actions: str, suggestions: list[str]) -> str:
    return (
        f"A secretary has checked your previously proposed actions : {error_actions}\n"
