...
United_States = CountryProfile(
    ...
    natural_industry_resource="(1) Geography: Large country with diverse landscapes\n" \
...
Soviet_Union = CountryProfile(
    ...
    natural_industry_resource="(1) Geography: Vast country but mostly landlocked.\n" \
    ...
    key_policy="(1) Focused on a strategy of scorched earth to deny resources to the invading forces.\n" \
...
China = CountryProfile(
    ...
    natural_industry_resource="(1) Geography: Vast country with diverse landscapes, including mountains, rivers, and coastlines.\n" \
...
France = CountryProfile(
    ...
    natural_industry_resource="(1) Geography: medium size country with a varied landscape including coastal areas, plains, and mountains.\n" \
...
Poland = CountryProfile(
    ...
    natural_industry_resource="(1) Geography: Located in Central Europe, with a mix of plains, forests, and mountains to the south.\n" \
