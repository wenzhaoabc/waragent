...
async def echo(websocket, path):
    ...
    async for message in websocket:
        ...
        # await websocket.send(json.dumps(mocked_data[0]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[1]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[2]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[3]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[4]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[5]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[6]))
        # await asyncio.sleep(2)
        # await websocket.send(json.dumps(mocked_data[7]))
